    ...
    >
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-1">
          ...
          <button className="ml-4 bg-gradient-to-r from-eunoia-purple to-eunoia-light-purple hover:from-eunoia-light-purple hover:to-eunoia-purple text-white px-5 py-2 rounded-md transition-all shadow-md hover:shadow-lg group">
        ...
        <div className="container mx-auto px-6 py-6 flex flex-col space-y-6">
          {navItems.map((item, index) => (
            <a 
              key={index}
              href={item.href} 
              className="font-sans text-eunoia-dark text-lg hover:text-eunoia-purple transition-colors py-2 border-b border-gray-100"
          ...
          <button className="w-full bg-gradient-to-r from-eunoia-purple to-eunoia-light-purple text-white py-3 rounded-md shadow-md mt-4">
            Get Started
          </button>
          
          <div className="pt-6 mt-auto">
            <div className="flex space-x-4 justify-center">
              <a href="#" className="text-eunoia-dark/60 hover:text-eunoia-purple transition-colors">
